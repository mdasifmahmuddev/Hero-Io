...
function Stats() {
  return (
    <div className="mx-auto p-4 sm:p-6 bg-gradient-to-r from-purple-500 to-indigo-500">
      <h1 className=" p-3 text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-white mb-4 sm:mb-6 px-2">
      ...
      <div className="stats stats-vertical lg:stats-horizontal w-full text-white bg-gradient-to-r from-purple-500 to-indigo-500 rounded-xl p-4 sm:p-6">
        <div className="stat text-center">
          ...
          <div className="stat-value text-2xl sm:text-3xl lg:text-4xl font-bold p-3">29.6M</div>
        ...
        <div className="stat text-center">
          ...
          <div className="stat-value text-2xl sm:text-3xl lg:text-4xl font-bold p-3">906K</div>
        ...
        <div className="stat text-center">
          ...
          <div className="stat-value text-2xl sm:text-3xl lg:text-4xl font-bold p-3">132+</div>
